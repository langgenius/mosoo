...
- App is the canonical engineering and user-facing noun. Avoid introducing parallel nouns such as Workspace, Team, Application, or Agent Service for this boundary.
...
- **App resource boundary**: move Agent, Thread / Session, Space, Environment, Skill, MCP, Provider Credential, Channel, Agent exposure state, export, and app-scoped Cost under one boundary.
