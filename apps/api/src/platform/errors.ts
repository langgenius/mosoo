...
export const API_ERROR_CODE = {
  ...
  vibeAppExists: "VIBE_APP_EXISTS",
  vibeAppUnavailable: "VIBE_APP_UNAVAILABLE",
  vibeAppUnconfigured: "VIBE_APP_UNCONFIGURED",
...
const API_ERROR_STATUS_BY_CODE = {
  ...
  [API_ERROR_CODE.vibeAppExists]: API_ERROR_STATUS.conflict,
  [API_ERROR_CODE.vibeAppUnavailable]: API_ERROR_STATUS.badGateway,
  [API_ERROR_CODE.vibeAppUnconfigured]: API_ERROR_STATUS.internalServerError,
