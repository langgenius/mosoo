...
titleAccent: "If"
description: "一封写给 agent builder 的信：我们为什么从本地实验走向 cloud agent session lifecycle API。"
date: 2026-05-28
category: "Product"
author: "mosoo team"
locale: "zh"
...
几个月前，我穿梭在若干家客户现场，讲我们新的 agent design in workflow。

每到现场，总有人问：为什么不试试 OpenClaw？这和 Hermes agent 有什么区别？

这并不是我第一次感觉到 get lost。

后来我意识到，困惑并不来自某一个工具本身，而是来自我们还没有说清楚一条边界：什么时候 agent 只是一次交付，什么时候它应该成为生产系统的一部分。
...
有些会关于 runtime internals，有些会关于 sandbox lifecycle，有些会关于部署、评估和从真实生产环境回收信号。

如果你也正在把 agent 从本地实验带进生产系统，希望这些 notes 能让旅程少一点迷雾。
