...
const documents: Documents = {
    ...
    "\n  query AppDeploymentStatus($appId: ULID!) {\n    appDeploymentStatus(appId: $appId) {\n      appId\n      createdAt\n      deploymentId\n      errorCode\n      errorMessage\n      id\n      liveUrl\n      plannedUrl\n      sourceBranch\n      sourceCommitSha\n      status\n      targetKind\n      updatedAt\n    }\n  }\n": types.AppDeploymentStatusDocument,
    ...
    "\n  query OrganizationBillingCostCard(\n    $organizationId: ULID!\n    $range: CostRange!\n    $runPurposes: [CostRunPurpose!]\n  ) {\n    organizationBillingCostCard(\n      organizationId: $organizationId\n      range: $range\n      runPurposes: $runPurposes\n    ) {\n      daily {\n        ...CostDailyFields\n      }\n      models {\n        ...CostModelFields\n      }\n      previousTotals {\n        ...CostTotalsFields\n      }\n      totals {\n        ...CostTotalsFields\n      }\n    }\n  }\n": types.OrganizationBillingCostCardDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query AppDeploymentStatus($appId: ULID!) {\n    appDeploymentStatus(appId: $appId) {\n      appId\n      createdAt\n      deploymentId\n      errorCode\n      errorMessage\n      id\n      liveUrl\n      plannedUrl\n      sourceBranch\n      sourceCommitSha\n      status\n      targetKind\n      updatedAt\n    }\n  }\n"): typeof import('./graphql').AppDeploymentStatusDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query OrganizationBillingCostCard(\n    $organizationId: ULID!\n    $range: CostRange!\n    $runPurposes: [CostRunPurpose!]\n  ) {\n    organizationBillingCostCard(\n      organizationId: $organizationId\n      range: $range\n      runPurposes: $runPurposes\n    ) {\n      daily {\n        ...CostDailyFields\n      }\n      models {\n        ...CostModelFields\n      }\n      previousTotals {\n        ...CostTotalsFields\n      }\n      totals {\n        ...CostTotalsFields\n      }\n    }\n  }\n"): typeof import('./graphql').OrganizationBillingCostCardDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
