...
const documents: Documents = {
    ...
    "\n  fragment AppDeploymentRunNativeFields on AppDeploymentRunNative {\n    facts {\n      agentCount\n      agents {\n        action\n        exposed\n        name\n        versionNumber\n      }\n      specVersion\n      web {\n        agent\n        declared\n      }\n    }\n    validate {\n      facts {\n        agentCount\n        agents {\n          exposed\n          name\n          source\n        }\n        spec\n        web {\n          agent\n          declared\n        }\n      }\n      failures {\n        action\n        code\n        field\n        file\n        problem\n        severity\n      }\n      schemaVersion\n      valid\n    }\n  }\n": types.AppDeploymentRunNativeFieldsFragmentDoc,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  fragment AppDeploymentRunNativeFields on AppDeploymentRunNative {\n    facts {\n      agentCount\n      agents {\n        action\n        exposed\n        name\n        versionNumber\n      }\n      specVersion\n      web {\n        agent\n        declared\n      }\n    }\n    validate {\n      facts {\n        agentCount\n        agents {\n          exposed\n          name\n          source\n        }\n        spec\n        web {\n          agent\n          declared\n        }\n      }\n      failures {\n        action\n        code\n        field\n        file\n        problem\n        severity\n      }\n      schemaVersion\n      valid\n    }\n  }\n"): typeof import('./graphql').AppDeploymentRunNativeFieldsFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
