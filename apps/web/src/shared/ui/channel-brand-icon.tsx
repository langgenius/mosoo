...
type BrandIconKey = AgentChannelBindingProvider;
...
function SlackSvg(props: SVGProps<SVGSVGElement>): ReactElement {
  ...
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
      <title>{t("channelNames.slack")}</title>
      <path
...
function LarkSvg(props: SVGProps<SVGSVGElement>): ReactElement {
  ...
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
      <title>{t("channelNames.lark")}</title>
      <path
...
function DiscordSvg(props: SVGProps<SVGSVGElement>): ReactElement {
  ...
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
      <title>{t("channelNames.discord")}</title>
      <path
...
function TelegramSvg(props: SVGProps<SVGSVGElement>): ReactElement {
  ...
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
      <title>{t("channelNames.telegram")}</title>
      <path
...
function WeChatSvg(props: SVGProps<SVGSVGElement>): ReactElement {
  ...
  return (
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
      <title>{t("channelNames.wechat")}</title>
      <path
