...
>
> **Current Project/App boundary note**: Channel setup remains attached to an App-local Agent service, but the owning delivery surface should move to App-first IA. Channel credentials, health, and usage should belong to Project/App before they become Organization-wide governance objects. See [Project / App Boundary](./project-app-boundary.md).
