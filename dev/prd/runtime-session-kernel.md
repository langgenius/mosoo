...
4. Be able to copy, publish, recover, and audit this Agent.
...
| Caller                 | The person or surface that triggered this session/event, for example a Builder, API caller, or Channel adapter. The Caller affects auditing and entry context but does not by default determine the Provider Credential.                                                                                                                                                                 |
| Product Manifest       | The user-understandable, auditable desired state of an Agent: runtime, model, prompt, `AGENTS.md`, Skills, MCP, Environment, Spaces.                                                                                                                                                                                                                                                     |
...
| Sandbox cache          | The rebuildable cache located at `/workspace/cache`, used for Environment packages, setup script artifacts, and the like.                                                                                                                                                                                                                                                                |
