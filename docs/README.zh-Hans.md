...
长期来看，我们希望 Mosoo 从开源社区版生长为同时支持个人、OPC、小团队和企业级治理的 Agent 基础设施：个人开发者可以自由实验和二次开发，团队可以沉淀自己的 Agent 与 Knowledge 资产，企业可以进一步获得权限、成本、审计、版本和运行状态管理能力。
...
- **企业级能力延展**：在个人和 OPC 场景跑通后，继续补齐团队协作、权限、审计、成本、版本控制和运行治理能力。
...
对管理员来说，Mosoo 希望提供一个易用的 WebUI，用来了解企业内有哪些 Agent 正在运行、谁能访问、谁正在使用、成本如何核算、审计如何追踪、版本如何控制，从而把内部 Agent 基础设施变成 managed infrastructure。
