...
Status: canonical target product contract, with API compatibility and Cloud migration clarified on September 18, 2026, the owner-approved BYOK release scope on September 19, and seamless existing-Session continuation reaffirmed on September 21. Single-turn tasks and multi-turn continuation share one durable Session contract. This document describes intended behavior; source, acceptance checks, and release evidence establish what is actually shipped.
