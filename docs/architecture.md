...
6. **Account & Organization Shell Service**
   - The current construction model is `Account -> Organization owner -> Project`. Workspace and Team are not architecture concepts. For this phase, one human owns one Organization and Project access maps to that owner.
