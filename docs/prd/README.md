...
- [Managed Agent v1 target and remaining slices](./managed-agent-v1.md) — shipped Project keys, BYOK Session and configuration work, with single-turn and multi-turn acceptance; platform supply and billing are separate.
