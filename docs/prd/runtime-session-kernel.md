...
- Conversation history and recorded files can outlive an execution environment. An isolated Session also restores its private working directory at the next turn, but that checkpoint is not a user-visible file asset or a complete machine image.
