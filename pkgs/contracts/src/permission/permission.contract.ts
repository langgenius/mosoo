...
export const Permission = {
  ...
  AuditOrganizationExport: "audit.export",
  AuditOrganizationRead: "audit.list",
  ...
  OrganizationServiceTokensManage: "org.service-tokens.manage",
...
const ROLE_PERMISSIONS = {
  admin: [
    ...
    Permission.AuditOrganizationExport,
    Permission.AuditOrganizationRead,
